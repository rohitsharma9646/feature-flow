...
By default, review unstaged changes from `git diff`. The caller may specify different files or scope to review. If the project is greenfield / not git-backed, review the working-tree files you are pointed at instead of a diff.
