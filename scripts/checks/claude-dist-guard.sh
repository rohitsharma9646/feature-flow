...
want_schema="assumption-records.md autopilot.md critic.md delivery.md design-tradeoffs.md discovery-fields.md disk-inference.md enforcement.md evidence.md knowledge-base.md planning-intelligence.md retrospective.md sign-off-rendering.md task-controller.md terminal-convergence.md "
[ "$(listing "$PKG/docs/schema" 2>/dev/null)" = "$want_schema" ] \
  && ok "docs/schema/ holds exactly the 15 topic files" \
  || err "docs/schema/ must hold exactly the 15 topic files (got [$(listing "$PKG/docs/schema" 2>/dev/null)])"
