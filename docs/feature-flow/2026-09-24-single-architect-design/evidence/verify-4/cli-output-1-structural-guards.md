# Structural guards — verify-4

Command per guard: `bash scripts/checks/<name>.sh`
...
ok:   rev lib/FS4: durable form {"paths":{"durable":"/tmp/tmp.Yp2MYzd15t/rev-repo/docs/ff"}} is excluded
