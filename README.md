...
| `/feature-flow:ff-design` | [feature] One architect (best design + rejected approaches) + lean trade-off matrix + devil's-advocate pass, record the chosen design → `design.md` |
